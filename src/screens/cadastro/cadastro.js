      ...
      <View style={style.containerCadastroForm}>
        ...
        <View
          style={
            fillFirstField == true
              ? { display: "flex", width: "100%", alignItems: "center" }
              : { position: "absolute", zIndex: 2, left: "-100%" }
          }
        >
          <TextInput
            style={style.cadastroInput}
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            {
              fillFirstField == false
                ? setFillFirstField(true)
                : createUser(Email, Endereco, CEP, CPF, nome, Senha);
            }
          }}
        >
          <Text style={{ color: "white", fontSize: 20 }}>
            {fillFirstField == true ? "Cadastrar" : "Próximo"}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
